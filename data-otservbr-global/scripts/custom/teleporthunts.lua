...
local tplist = {
    ...
    [40033] = {name = "Wyrm", level = {40, 40, 40}, positions = {{x = 32385, y = 322770, z = 3}, {x = 32403 , y = 32747, z = 1}, {x = 32388 , y = 32838, z = 7}}, subareas = {'Wyrm Mountain1', 'Wyrm Mountain2', 'Wyrm Sul LB'}},
