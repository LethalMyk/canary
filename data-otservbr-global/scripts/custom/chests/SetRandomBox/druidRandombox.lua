...
local rewards = {
    ...
    { id = 31578, name = "Bear Skin", chance = 030 },            -- 
    { id = 39165, name = "Midnight Tunic", chance = 030 },            -- 
    { id = 39167, name = "Midnight Sarong", chance = 030 },            -- 
    { id = 40595, name = "Mutant Bone Kilt", chance = 030 },            -- 
    { id = 36671, name = "Eldritch Hood", chance = 030 },            -- 
    { id = 35520, name = "Make-do Boots", chance = 030 },            -- 
    { id = 40593, name = "Mutant Bone Boots", chance = 030 },            -- 
    
    { id = x, name = "x", chance = 030 },            -- 
    { id = x, name = "x", chance = 030 },            -- 
