local internalNpcName = "Up Level"
...
local function creatureSayCallback(npc, creature, type, message)
    ...
    if MsgContains(message, message) then
        if creature:getLevel() + tostring(message) <= levelMax then
            ...
            creature:addExperience(addExp, false)
        else
            return false
        end
    end
...
npcHandler:setMessage(MESSAGE_GREET, "Ola quantos leveis deseja ganhar no maximo " .. levelMax .. "?")
