local config = {
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        Position(31880, 32123, 9),
        Position(31881, 32123, 9),
        Position(31882, 32123, 9),
        Position(31883, 32123, 9), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(31884, 32123, 9),
        Position(31885, 32123, 9),
        Position(31886, 32123, 9),
    }
}
