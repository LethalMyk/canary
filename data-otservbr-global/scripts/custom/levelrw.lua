...
local table = 
{
    ...
    [20] = {type = "item", id = {3043, 2}, msg = "Recompensa: 20k por chegar ao level 20!"},
    [3000] = {type = "bank", id = {20000, 0}, msg = "Foi depositado em seu bank 20000 gold coints!"},
    [50] = {type = "addon", id = {136, 128}, msg = "Voce ganhou o addon citizen full por alcancar o level 40!"},
    [100] = {type = "mount", id = {2, 0}, msg = "Voce ganhou uma montaria!"},
}
