local config = {
    ...
    prizePool = {
        ...
        {itemId = 3043, count = {40, 100},   chance = 20000}, 
        {itemId = 37109, count = {10, 60},    chance = 20000},
        {itemId = 37110, count = {1, 2},    chance = 20000},
        {itemId = 22516, count = {6, 10},   chance = 20000},
        {itemId = 22721, count = {6, 10}, chance = 20000},  

        {itemId = 60848, count = {1, 1},    chance = 20000},
        {itemId = 60849, count = {1, 1},    chance = 20000},
        {itemId = 60850, count = {1, 1},    chance = 20000},
        {itemId = 60851, count = {1, 1},    chance = 20000},
        {itemId = 60852, count = {1, 1},    chance = 20000},
        {itemId = 60853, count = {1, 1},    chance = 20000},
        {itemId = 60854, count = {1, 1},    chance = 20000},
        {itemId = 9086, count = {1, 1},    chance = 20000},
        {itemId = 28484, count = {1, 1},    chance = 20000},
        {itemId = 9079, count = {1, 1},    chance = 20000},
        {itemId = 28485, count = {1, 1},    chance = 20000},
        {itemId = 60132, count = {1, 1},    chance = 20000},


        {itemId = 60146, count = {1, 1},    chance = 20000},


        {itemId = 61015, count = {1, 1},    chance = 10000}, --amulet box



        {itemId = 60151, count = {1, 1},    chance = 5000}, -- Taining rod box
        {itemId = 60152, count = {1, 1},    chance = 5000}, -- Frag Remover
        {itemId = 60132, count = {1, 1},    chance = 5000}, -- Teleport Scroll vai volta
        {itemId = 60039, count = {1, 1},    chance = 5000}, -- Mount Box
        {itemId = 61008, count = {1, 1},    chance = 5000}, -- Ninetails Backpack
        {itemId = 61020, count = {1, 1},    chance = 5000}, -- Ninetails Backpack
        {itemId = 60980, count = {1, 1},    chance = 5000}, -- Anubis Backpack
        {itemId = 60981, count = {1, 1},    chance = 5000}, -- One Piece Backpack
        {itemId = 60982, count = {1, 1},    chance = 5000}, -- Mewtwo Backpack
        {itemId = 60784, count = {1, 1},    chance = 5000}, -- Pickaxu Backpack


        


        {itemId = 60902, count = {1, 1},    chance = 2000},
        {itemId = 61016, count = {1, 1},    chance = 2000},
        {itemId = 60905, count = {1, 11},   chance = 2000},
        {itemId = 60906, count = {1, 1},    chance = 2000},
        {itemId = 60909, count = {1, 1},    chance = 2000},
        {itemId = 60910, count = {1, 1},    chance = 2000},
        {itemId = 60912, count = {1, 1},    chance = 2000},
        {itemId = 60914, count = {1, 1},    chance = 2000},
        {itemId = 60131, count = {1, 1},    chance = 2000},
        {itemId = 60477, count = {1, 1},    chance = 2000},
        {itemId = 60130, count = {1, 1},    chance = 2000},


        
        {itemId = 60039, count = {1, 1},    chance = 100}, -- Wing Addon

        {itemId = 34109, count = {1, 1},    chance = 1000 },
        {itemId = 39546, count = {1, 1},    chance = 1000  },
        {itemId = 43860, count = {1, 1},    chance = 1000  }
    },
